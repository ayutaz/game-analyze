...
これは**コードベースではなく、リサーチ成果物（Markdown + JSON のドキュメント集）** を保管するワークスペースです。`/Users/yousan/Desktop/game-analyze/` 配下で、国内（日本）と国際市場で著名なゲーム計 917 本（うち 2020+ インディー 103 本、PC 拡張 500 本、2023+ インディー追補 114 本を含む）を以下3カテゴリに分類した分析カタログを管理します。
...
期待値（2026-06-24 時点）: total=917 / EXP 689, NAR 125, REW 103 / ids missing=[] / collisions=0
社会軸 (EXP のみ): ソロ 501 / 対戦 97 / 協力 69 / 非同期 5 / 非対称 5 / 観戦 3 / 未設定 9
